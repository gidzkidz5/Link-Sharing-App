...
const SecondaryNav = () => {
  ...
  //         label: 'Links',
  //         active: pathname === `/${params.profileId}`,
  //     },
  //     {
  //         href:`/${params.profileId}/profile-details` ,
  //         label: 'Profile Details',
  //         active: pathname === `/${params.profileId}/profile-details`,
  //     }
  // ]

  return (
    <div className="flex justify-between p-4 rounded-lg bg-white items-center">
      <div className="hidden md:inline" id="logoBig">
        <svg
      ...
      <div className="md:hidden flex gap-2 items-center" id="logoSmall">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="38"
          height="38"
      ...
      <nav className="flex gap-4">
        ...
        >
          ...
          <p className="fs-bold-S hidden md:block">Links</p>
        </Link>
        ...
        <Link
          ...
          href={`/profile/${params.profileId}/profile-details`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="19"
          ...
          <p className="fs-bold-S hidden md:block">Profile Details</p>
        </Link>
      </nav>
