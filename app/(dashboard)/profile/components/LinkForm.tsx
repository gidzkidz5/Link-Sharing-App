...
const LinkForm = () => {
  ...
  const handleSelectChange = (value: any, id: number) => {
    ...
    if (platforms?.includes(value)) {
      toast.error("Cannot have 2 of the same platform", { id: "error unique" });
    } else {
      //@ts-ignore
  ...
  const removeLink = (e: any, id: number) => {
    e.preventDefault();
  ...
  return (
    <form onSubmit={handleSubmit} id="myForm">
      <Reorder.Group
        axis="y"
        values={formDataLocal!}
        onReorder={setFormDataLocal!}
        className="space-y-5"
      >
        {formDataLocal!.map((item, id) => {
          if (id < formLinkCount!) {
            return (
              <Reorder.Item
